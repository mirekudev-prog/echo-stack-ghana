...
class Follow(Base):
    ...
    id          = Column(Integer, primary_key=True, index=True)
    follower_id = Column(UUID(as_uuid=True), ForeignKey("es_users.id"), nullable=False)
    creator_id  = Column(UUID(as_uuid=True), ForeignKey("es_users.id"), nullable=False)
    created_at  = Column(DateTime, default=datetime.utcnow)
...
class ChatMessage(Base):
    ...
    id          = Column(Integer, primary_key=True, index=True)
    user_id     = Column(UUID(as_uuid=True), ForeignKey("es_users.id"), nullable=True)
...
class Like(Base):
    ...
    id         = Column(Integer, primary_key=True, index=True)
    post_id    = Column(Integer, ForeignKey("posts.id"), nullable=False)
    user_id    = Column(UUID(as_uuid=True), ForeignKey("es_users.id"), nullable=False)
    created_at = Column(DateTime, default=datetime.utcnow)
...
class CreatorChannel(Base):
    ...
    id                  = Column(Integer, primary_key=True, index=True)
    user_id             = Column(UUID(as_uuid=True), ForeignKey("es_users.id"), nullable=False, unique=True)
    channel_name        = Column(String(200))
